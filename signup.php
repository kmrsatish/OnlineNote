...
$message .= "satish.thecompletewebhosting.com/NotesAppFinal/activate.php?email=" . urlencode($email) . "&key=$activationKey";
if(mail($email, 'Confirm your Registration', $message, 'From:'.'ksatish223@gmail.com')){
